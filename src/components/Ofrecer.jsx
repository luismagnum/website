    ...
    return (
      <div className='text-center mx-auto mt-10 md:mt-20 mb-20 px-4 md:px-8'>
        <h1 className='text-3xl text-[#00ff00] font-bold mb-4'>¿Requieres un diseño Web?</h1>
         <h2 className="text-xl md:text-2xl text-white font-bold">Realizamos Diseño Web Profesional y a tu medida</h2>
         <h2 className="text-xl md:text-2xl text-white font-bold">Creacion de paginas web para ventas online</h2>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div data-aos="fade-right" className='text-center mx-auto w-full md:w-3/4 p-4 rounded-lg shadow-md'>
            ...
            <div className='p-2'>
              ...
              <p className='text-white sm:text-xs md:text-xl text-justify'>
