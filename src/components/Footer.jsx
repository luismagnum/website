...
const Footer = () => {
    ...
    <footer className='bg-gray-950 p-4 mb-10'>
      ...
      <div className='md:flex md:justify-between md: items-center sm:px-12 px-4 py-7'>
        <h1 className='text-white lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5'><span className='text-[#00ff00] mr-3'>Paid Media</span>Te gustaria empezar un proyecto con nosotros?</h1>
        <div className='grid grid-cols-1 md:grid-cols-2'>
          ...
          <span className='text-[#00ff00a5] hover:text-gray-400 font-bold sm:text-sm md:text-base'>Contratar tus servicios</span>
          </a>
          </button>
        </div>
      </div>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center file:mx-auto pt-2 text-white text-sm pb-8 mt-20'>
        <span className='text-base'>Developer Web Luis E. Diaz</span>
        <span className='text-base'>@2024 MKT</span>
      </div>
