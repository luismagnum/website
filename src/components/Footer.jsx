...
const Footer = () => {
    ...
    <footer className='bg-gray-950 p-4 mb-10'>
      ...
      <div className='md:flex md:justify-between md: items-center sm:px-12 px-4 py-7'>
        <h1 className='text-white lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5'><span className='text-[#00ff00] mr-3'>SpeedWeb</span>Te gustaria empezar un proyecto con nosotros?</h1>
