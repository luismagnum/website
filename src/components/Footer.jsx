...
const Footer = () => {
    ...
    <footer className='bg-gray-950 p-4 mb-10'>
      ...
      <div className='md:flex md:justify-between md: items-center sm:px-12 px-4 py-7'>
        <h1 className='text-gray-600 lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5'><span className='text-[#00ff00] mr-3'>SpeedWeb</span>Te gustaria empezar un proyecto con nosotros?</h1>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center file:mx-auto pt-2 text-gray-600 text-sm pb-8 mt-20'>
